...
class KanHafta extends StatefulWidget {
  @override
  _KanHaftaState createState() => _KanHaftaState();
}

class _KanHaftaState extends State<KanHafta> {
  DateTime pickedDate;
              ...
              children: [
                Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text("40",style: TextStyle(color: Colors.red,fontSize: 25,),),
                        Padding(
                ...
                Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text("30",style: TextStyle(color: Colors.red,fontSize: 25,),),
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text("mmHg"),
                        ),
