...
class KalpAy extends StatefulWidget {
  @override
  _KalpAyState createState() => _KalpAyState();
}

class _KalpAyState extends State<KalpAy> {
  DateTime pickedDate;
              ...
              children: [
                Column(
                  children: [
                    Row(
                      children: [
                        Text("80.0",style: TextStyle(color: Colors.red,fontSize: 25,),),
                        Padding(
                ...
                Column(
                  children: [
                    Row(
                      children: [
                        Text("50.0",style: TextStyle(color: Colors.red,fontSize: 25,),),
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text("bpm"),
                        ),
