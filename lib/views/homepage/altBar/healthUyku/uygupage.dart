...
import 'package:petsapp/views/homepage/altBar/healthUyku/uykuay.dart';
import 'package:petsapp/views/homepage/altBar/healthUyku/uykuhafta.dart';

class UykuPage extends StatefulWidget {
  @override
  _UykuPageState createState() => _UykuPageState();
}

class _UykuPageState extends State<UykuPage> with TickerProviderStateMixin {
