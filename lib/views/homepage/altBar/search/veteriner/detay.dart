                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(veterinerInfo[widget.id].image),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    "${veterinerInfo[widget.id].name}",
                                    style: Theme.of(context).textTheme.subtitle,
                                  ),
                                  /*
                                  Text(
                                    "${veterinerInfo[widget.id].type}",
                        ...
                        Row(
                          children: <Widget>[
                            SmoothStarRating(
                              rating: veterinerInfo[widget.id].reviews,
                              size: 15,
                              color: MyColors.orange,
                            ),
                            Text("(${veterinerInfo[0].reviewCount} Reviews)"),
                            Expanded(
                              child: FlatButton(
                                child: FittedBox(
                                  child: Text(
                        ...
                        Row(
                          children: <Widget>[
                            Text("${veterinerInfo[widget.id].workingHours}"),
                            SizedBox(width: 15),
                            GestureDetector(
                              onTap: () {},
                              child: Container(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Column(
                              children: <Widget>[
                                Text("${veterinerInfo[widget.id].patientsCount}",
                            ...
                            Column(
                              children: <Widget>[
                                Text(
                                    "${veterinerInfo[widget.id].experience} Years",
                                    style: Theme.of(context).textTheme.title),
                                Text(
                                  "Experience",
                                  style: TextStyle(color: Colors.grey),
                            ...
                            Column(
                              children: <Widget>[
                                Text("${veterinerInfo[widget.id].certifications}",
                                    style: Theme.of(context).textTheme.title),
                                Text(
                                  "Certifications",
                                  style: TextStyle(color: Colors.grey),
