...
import 'package:petsapp/views/homepage/altBar/healthAdim/adimay.dart';
import 'package:petsapp/views/homepage/altBar/healthAdim/adimgun.dart';
import 'package:petsapp/views/homepage/altBar/healthAdim/adimhafta.dart';

class AdimPage extends StatefulWidget {
  @override
  _AdimPageState createState() => _AdimPageState();
}

class _AdimPageState extends State<AdimPage> with TickerProviderStateMixin {
