...
import 'package:petsapp/views/homepage/altBar/healthVucud/vucuday.dart';
import 'package:petsapp/views/homepage/altBar/healthVucud/vucudgun.dart';
import 'package:petsapp/views/homepage/altBar/healthVucud/vucudhafta.dart';


class VucudPage extends StatefulWidget {
  @override
  _VucudPageState createState() => _VucudPageState();
}

class _VucudPageState extends State<VucudPage> with TickerProviderStateMixin {
